...
<div class="row">
    <div class="container">
        ...
        <div class="container text-left mb-3">
            <form action="<%= request.getContextPath() %>/caseinfo/search" method="get" class="form-inline">
                <input type="text" name="keyword" class="form-control mr-2" placeholder="Search by title..." required />
