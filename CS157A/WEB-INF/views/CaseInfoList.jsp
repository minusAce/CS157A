...
<header>
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
        <ul class="navbar-nav">
            <li><a href="<%= request.getContextPath() %>/list" class="nav-link">Case Info</a></li>
        </ul>
    </nav>
</header>
<br>
...
<div class="row">
    <div class="container">
        ...
        <div class="container text-left">
            <a href="<%= request.getContextPath() %>/register" class="btn btn-success">Add New Case Info</a>
        </div>
        <br>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit?caseID=<%= caseInfo.getCaseID() %>">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="delete?caseID=<%= caseInfo.getCaseID() %>">Delete</a>
                    </td>
                </tr>
                <%
                        }
